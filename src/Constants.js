...
export let DINOSAUR_TRANSLATIONS = ["Dinosaur", "Dinosaure", "Dinosaurier", "Dinosauro", "Dinosaurio"]
export let DOG_TRANSLATIONS = ["Dog", "Chien", "Hund", "Cane", "Perro"]
export let FROG_TRANSLATIONS = ["Frog", "Grenouille", "Frosch", "Rana", "Rana"]
